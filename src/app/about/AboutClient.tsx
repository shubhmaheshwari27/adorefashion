...
export default function AboutClient() {
  ...
  const aboutPageStructuredData = {
    ...
    description: "Discover the passion and craftsmanship behind Adore, where tradition meets contemporary elegance.",
    mainEntity: {
      "@type": "Organization",
      name: "Adore Fashion",
      foundingDate: "2010",
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <AnimatedScroll direction="right">
                <div className="space-y-6">
                  ...
                  <h2 className="heading-md text-gradient">The Adore Journey</h2>
                  <div className="w-20 h-1 bg-amber-600"></div>
                  <p className="text-muted-foreground text-lg">
                    Adore was born out of a deep love for Indian textiles and a vision to create clothing that
                    celebrates the rich heritage of Indian craftsmanship while embracing contemporary design
                    sensibilities.
                  </p>
                  <p className="text-muted-foreground text-lg">
                    Founded in 2010 by Priya Sharma, a textile designer with over 15 years of experience, Adore started
                    as a small boutique in Mumbai with a handful of artisans. Today, we have grown into a beloved brand
                    that works with over 100 skilled craftspeople across India.
                  </p>
                  <p className="text-muted-foreground text-lg">
                    Our journey has been one of discovery, learning, and a constant pursuit of excellence. We have
                    traveled to remote villages to learn traditional techniques, collaborated with master artisans, and
                    continuously evolved our designs to create pieces that are both timeless and contemporary.
                  </p>
                </div>
              </AnimatedScroll>
          ...
          <div className="container mx-auto px-6 md:px-12">
            <AnimatedScroll>
              <div className="text-center mb-16">
                ...
                <h2 className="heading-md text-gradient mb-6">Our Philosophy</h2>
                <div className="w-20 h-1 bg-amber-600 mx-auto mb-6"></div>
                <p className="text-muted-foreground max-w-3xl mx-auto text-lg">
                  At Adore, we believe that clothing is not just about covering the body, but about expressing one's
                  identity, culture, and emotions. Our designs reflect this philosophy, offering you not just garments,
                  but stories woven in threads.
                </p>
              </div>
            </AnimatedScroll>
              ...
              {[
                ...
                <AnimatedScroll key={index} delay={value.delay}>
                  <div className="glassmorphism p-10 rounded-xl text-center hover:shadow-lg transform hover:-translate-y-2 transition-all duration-300">
                    ...
                    <h3 className="text-2xl font-heading font-bold mb-4 text-amber-800">{value.title}</h3>
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="container mx-auto px-6 md:px-12">
            <AnimatedScroll>
              <div className="text-center mb-16">
                <span className="text-amber-600 font-medium">THE FACES BEHIND ADORE</span>
                <h2 className="heading-md text-gradient mb-6">Meet Our Team</h2>
                <div className="w-20 h-1 bg-amber-600 mx-auto mb-6"></div>
                <p className="text-muted-foreground max-w-3xl mx-auto text-lg">
                  Behind every beautiful garment is a team of passionate individuals dedicated to bringing our vision to
                  life.
                </p>
              </div>
            </AnimatedScroll>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
              {[
                { name: "Priya Sharma", role: "Founder & Creative Director", image: "201", delay: 0 },
                { name: "Arjun Mehta", role: "Head Designer", image: "202", delay: 200 },
                { name: "Neha Kapoor", role: "Textile Specialist", image: "203", delay: 400 },
                { name: "Raj Patel", role: "Master Craftsman", image: "204", delay: 600 },
              ].map((member, index) => (
                <AnimatedScroll key={index} delay={member.delay}>
                  <div className="text-center group">
                    <div className="relative h-64 w-64 mx-auto mb-6 overflow-hidden rounded-full">
                      <Image
                        src={`/placeholder.svg?height=${member.image}&width=200`}
                        alt={member.name}
                        fill
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <AnimatedScroll direction="right">
                <div className="relative h-[600px] rounded-xl overflow-hidden">
                  <Image
                    src="/placeholder.svg?height=1001&width=800"
                    alt="Our Artisans"
                    fill
                    className="object-cover transition-scale"
                  />
              ...
              <AnimatedScroll direction="left">
                <div className="space-y-6">
                  <span className="text-amber-600 font-medium">THE HANDS BEHIND THE CRAFT</span>
                  <h2 className="heading-md text-gradient">Our Artisans</h2>
                  <div className="w-20 h-1 bg-amber-600"></div>
                  <p className="text-muted-foreground text-lg">
                    The heart and soul of Adore are our skilled artisans who bring our designs to life with their
                    exceptional craftsmanship. Many of them have been with us since our inception, and their dedication
                    to their craft is what makes our garments truly special.
                  </p>
                  <p className="text-muted-foreground text-lg">
                    We work with artisans from various regions of India, each bringing their unique skills and
                    traditional techniques to our collections. From the intricate zardozi embroiderers of Lucknow to the
                    bandhani tie-dye artists of Gujarat, our network of craftspeople represents the diverse textile
                    traditions of India.
                  </p>
                  <p className="text-muted-foreground text-lg">
                    We believe in fair trade practices and ensuring that our artisans receive fair compensation for
                    their work. We also invest in their skill development and provide them with a safe and supportive
                    working environment.
                  </p>
                </div>
              </AnimatedScroll>
          ...
          <div className="container mx-auto px-6 md:px-12">
            <AnimatedScroll>
              <div className="text-center mb-16">
                ...
                <h2 className="heading-md text-gradient mb-6">What Our Customers Say</h2>
                <div className="w-20 h-1 bg-amber-600 mx-auto mb-6"></div>
                <p className="text-muted-foreground max-w-3xl mx-auto text-lg">
                  ...
                  <div className="glassmorphism p-8 rounded-xl hover:shadow-lg transition-all">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="relative h-16 w-16 overflow-hidden rounded-full border-2 border-amber-300">
                        <Image
                          src={`/placeholder.svg?height=${testimonial.image}&width=301`}
            ...
            <div className="max-w-4xl mx-auto text-center">
              <AnimatedScroll>
                ...
                <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                  Experience the beauty and craftsmanship of our collections in person. Visit our boutique or book a
                  virtual consultation with our stylists.
                </p>
                <div className="flex flex-col sm:flex-row justify-center gap-6">
                  <Button size="lg" className="bg-white text-amber-900 hover:bg-amber-100 rounded-full py-6 px-8">
                    Book Consultation
                  </Button>
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white text-white hover:bg-white/20 rounded-full py-6 px-8"
                  >
                    Contact Us
                  </Button>
                </div>
