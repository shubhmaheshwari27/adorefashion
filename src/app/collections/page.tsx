...
export default function Collections() {
      ...
      items: [
        {
          ...
          image: "2001",
          description:
            "Stunning royal red bridal lehenga with intricate gold embroidery",
        },
        {
          ...
          image: "2002",
          description:
            "Luxurious gold embroidered lehenga with traditional motifs",
        },
        {
          ...
          image: "2003",
          description:
            "Elegant pastel pink bridal set with delicate silver work",
        },
        {
          ...
          image: "2004",
          description:
            "Rich maroon velvet lehenga with heritage zardozi embroidery",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          image: "3001",
          description:
            "Traditional Banarasi silk saree with intricate gold work",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          image: "4003",
          description:
            "Comfortable and stylish kurta set for Holi celebrations",
        },
        {
      ...
      items: [
        {
          ...
          image: "5001",
          description:
            "Modern dhoti jumpsuit combining traditional and western elements",
        },
        {
  ...
  const allProducts = categories.flatMap((category) =>
    category.items.map((item) => ({
      ...item,
      image: `https://adorefashion.in/assets/placeholders/adore_placeholder.jpg?height=${item.image}&width=600`,
    }))
  );
      ...
      <main>
        ...
        <section className="relative h-[70vh] flex items-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <ParallaxImage
              src="/assets/placeholders/adore_placeholder.jpg?height=800&width=1920"
            ...
            <AnimatedScroll>
              <div className="max-w-xl space-y-5">
                ...
                <p className="text-xl text-white/90">
                  Explore our exquisite range of Indian ethnic wear, each piece
                  telling a story of tradition and craftsmanship.
                </p>
              </div>
            </AnimatedScroll>
          </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center mb-8 sm:mb-16">
                  ...
                  >
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          handleProductClick(category.title, category.image)
                        }
                  ...
                  >
                    <div className="relative h-[300px] sm:h-[400px] md:h-[500px] rounded-xl overflow-hidden">
                      <Image
                        src={`/assets/placeholders/adore_placeholder.jpg?height=${category.image}&width=800`}
                  ...
                  {category.items.map((item, itemIndex) => (
                    <div key={itemIndex} className="group">
                      <div className="relative h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] overflow-hidden rounded-xl mb-4">
                        <Image
                          src={`/assets/placeholders/adore_placeholder.jpg?height=${item.image}&width=600`}
            ...
            <div className="max-w-4xl mx-auto text-center">
              <AnimatedScroll>
                ...
                <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                  We offer custom design services to create the perfect outfit
                  for your special occasion. Our designers will work closely
